...
This list and every `SKILL.md` under [`resources/`](resources) are released under [CC0 1.0 Universal](LICENSE) — public domain. Copy them, tweak them to match your own conventions, ship them in your projects, commercial or not. No attribution required.

Linked third-party skills and repositories keep their own licenses.
